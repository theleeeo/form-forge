...
const (
	FormService_GetByID_FullMethodName = "/form.FormService/GetByID"
	FormService_Create_FullMethodName  = "/form.FormService/Create"
)
...
type FormServiceClient interface {
	GetByID(ctx context.Context, in *GetByIdParameters, opts ...grpc.CallOption) (*Form, error)
	Create(ctx context.Context, in *CreateParameters, opts ...grpc.CallOption) (*Form, error)
}
...
func (c *formServiceClient) GetByID(ctx context.Context, in *GetByIdParameters, opts ...grpc.CallOption) (*Form, error) {
	out := new(Form)
...
func (c *formServiceClient) Create(ctx context.Context, in *CreateParameters, opts ...grpc.CallOption) (*Form, error) {
	out := new(Form)
...
type FormServiceServer interface {
	GetByID(context.Context, *GetByIdParameters) (*Form, error)
	Create(context.Context, *CreateParameters) (*Form, error)
...
func (UnimplementedFormServiceServer) GetByID(context.Context, *GetByIdParameters) (*Form, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByID not implemented")
}
func (UnimplementedFormServiceServer) Create(context.Context, *CreateParameters) (*Form, error) {
...
func _FormService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FormServiceServer).GetByID(ctx, req.(*GetByIdParameters))
	}
...
func _FormService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FormServiceServer).Create(ctx, req.(*CreateParameters))
	}
	return interceptor(ctx, in, info, handler)
}
